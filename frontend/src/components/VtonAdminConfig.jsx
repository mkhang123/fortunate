    ...
    return (
        <div className="border border-gray-200 rounded-sm bg-white p-4 space-y-4">
            ...
            <div className="flex items-center gap-2 border-b border-gray-100 pb-3">
                ...
                <h3 className="text-xs font-black uppercase tracking-wider">Cấu hình AI Server</h3>
                <span className="ml-auto text-[9px] text-gray-400 uppercase font-bold">Admin Only</span>
            </div>

            {/* Current Mode */}
            {!isFetching && currentConfig && (
                <div className="flex items-center gap-2">
                    <span className="text-[10px] text-gray-500 font-bold uppercase">Mode hiện tại:</span>
            ...
            <div className="space-y-2">
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="bg-black text-white px-4 py-2 text-[10px] font-black uppercase tracking-widest hover:bg-gray-800 transition-colors disabled:bg-gray-300 rounded-sm flex items-center gap-1.5"
                    >
            ...
            <div className="bg-gray-50 p-3 rounded-sm space-y-1">
                <p className="text-[9px] font-black uppercase tracking-wider text-gray-500 mb-2">Cách lấy link Colab:</p>
