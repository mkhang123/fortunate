                        ...
                        >
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className="bg-black text-white px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-wider hover:bg-gray-800 transition-all flex items-center gap-2 group/btn"
                                >
