            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
                <div>
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="bg-black text-white text-[8px] font-black px-2 py-1 rounded-sm shadow-sm animate-pulse tracking-widest italic">
                            Hot
                        </span>
                    </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {isSoldOut && (
                                            <div className="absolute bottom-4 left-4 z-10 bg-white text-black px-2 py-1 text-[8px] font-black tracking-widest border border-black shadow-md">
                                                Hết hàng
                                            </div>
                                        )}
