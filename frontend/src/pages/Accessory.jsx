...
export default function Accessory() {
 ...
 {isSoldOut && (
 <div className="absolute top-3 left-3 z-10 bg-white text-black px-2 py-1 text-[8px] font-black tracking-widest border border-black shadow-md">
 Hết hàng
 </div>
 )}
 <img
 ...
 <h3 className="text-sm font-semibold mb-1 tracking-tight group-hover:underline">
 {product.name}
 </h3>
