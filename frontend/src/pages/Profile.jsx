    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <h3
            className={
              titleClassName ?? "text-sm font-black uppercase tracking-widest text-gray-900"
            }
          >
            {title}
          </h3>
      ...
      <div className="mt-10 bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
        ...
        {wishlistLoading ? (
          ...
          <div className="text-center py-12 border-2 border-dashed border-gray-100 rounded-xl">
            ...
            <Link
              to="/featured"
              className="inline-block px-5 py-2 border border-black text-black text-xs font-black uppercase tracking-widest rounded-lg hover:bg-black hover:text-white transition-colors"
            >
              Khám phá sản phẩm
            </Link>
          </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-4 flex gap-2">
                      <Link
                        ...
                        className="flex-1 text-center py-2 border border-black text-[10px] font-black uppercase tracking-wider rounded-lg hover:bg-black hover:text-white transition-colors"
                      >
                        Xem chi tiết
                      </Link>
                      <button
                        onClick={() => handleRemoveWishlist(product.id)}
                        className="px-3 py-2 border border-red-200 text-red-600 text-[10px] font-black uppercase tracking-wider rounded-lg hover:bg-red-50 transition-colors"
                      >
                        Bỏ thích
                      </button>
                    </div>
