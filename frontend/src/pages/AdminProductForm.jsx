    ...
    <div className="p-8 max-w-7xl mx-auto font-sans">
      <div className="flex items-center justify-between gap-3 mb-6">
        ...
        <button
          ...
          className="px-4 py-2 text-xs font-bold uppercase rounded border border-gray-300 hover:bg-gray-50"
        >
          Quay lại
        </button>
      </div>
      ...
      >
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          <h2 className="text-xs font-black tracking-wider uppercase text-gray-700 mb-4">
            Thông tin cơ bản
          </h2>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <button
            type="submit"
              className={`text-white font-bold p-3 flex-1 rounded uppercase transition-all shadow-md ${
