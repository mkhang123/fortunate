...
export default function MainDisplay() {
 ...
 <h2 className="text-[10px] md:text-xs font-bold tracking-[0.6em] mb-4 animate-in fade-in slide-in-from-bottom duration-700">
 Fortunate New Generation 2026
 </h2>
 <h1 className="text-6xl md:text-9xl font-black italic tracking-tighter mb-8 animate-in fade-in slide-in-from-bottom duration-1000">
 Fortunate
 </h1>
 <Link 
 to="/clothes" 
 className="bg-white text-black px-12 py-4 text-[10px] font-black tracking-[0.2em] hover:bg-black hover:text-white transition-all duration-300 shadow-2xl active:scale-95"
 >
 Mua sắm ngay
 </Link>
 </div>
 ...
 <div>
 <h2 className="text-4xl font-black italic tracking-tighter">Collections</h2>
 ...
 <h3 className="text-4xl font-black italic text-white mb-3 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
 {collection.name}
 </h3>
 ...
 <h2 className="text-4xl md:text-6xl font-black italic text-white tracking-tighter mb-10 leading-tight">
