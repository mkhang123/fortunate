    ...
    return (
        <div className="max-w-[1440px] mx-auto px-6 lg:px-16 py-12 bg-white min-h-screen">
            ...
            <button
                ...
                className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-600 hover:text-black transition-colors mb-8 group"
            >
            ...
            <div className="flex flex-wrap items-start justify-between gap-4 mb-12">
                ...
                <div className="flex flex-col items-end gap-2">
                    <span
                        className={`px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-wider border ${getStatusColor(
                            order.status
                        )}`}
                    >
                    ...
                    {order.payment && (
                        <span
                            className={`px-3 py-1 rounded-full text-[9px] font-bold uppercase tracking-wider ${order.payment.status === "SUCCESS"
                                ...
                                <div key={item.id} className="flex gap-4 border-b pb-6 last:border-0">
                                    ...
                                    <div className="flex-1">
                                        <Link
                                            ...
                                            className="font-black text-sm uppercase tracking-tight hover:text-red-600 transition-colors block mb-2"
                                        >
                            ...
                            order.payment?.status === "PENDING" && (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-blue-600 text-white py-3 rounded-xl text-[10px] font-black uppercase tracking-wider hover:bg-blue-700 transition-all"
                                    >
                                        Thanh toán lại
                                    </button>
                                </>
