              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    <th className="text-left py-4 px-4 text-[10px] font-black tracking-widest text-gray-600">
                      Mã ĐH
                    </th>
                    <th className="text-left py-4 px-4 text-[10px] font-black tracking-widest text-gray-600">
                      Khách hàng
                    ...
                    <th className="text-right py-4 px-4 text-[10px] font-black tracking-widest text-gray-600">
                      Thao tác
                    </th>
                  </tr>
                </thead>
                    ...
                    >
                      ...
                      <td className="py-4 px-4">
                        <select
                          ...
                          className={`text-[9px] font-black px-3 py-1 rounded-full border cursor-pointer ${getStatusColor(
                            order.status
                          )}`}
                        >
                          <option value="PENDING">Đang xử lý</option>
