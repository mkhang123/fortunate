...
export default function AboutUs() {
 ...
 <span className="text-[10px] font-black tracking-[0.4em] ">The Origin Story</span>
 </div>
 <h2 className="text-5xl md:text-7xl font-black tracking-tighter leading-[0.85] mb-12 italic text-black">
 ...
 <div className="pt-4">
 <Link to="/clothes" className="group inline-flex items-center gap-4 text-xs font-black tracking-widest border-b-4 border-black pb-2 hover:gap-10 transition-all duration-500">
 ...
 <h2 className="text-5xl font-black tracking-tighter mb-4 italic">Core Values</h2>
 <p className="text-gray-400 text-[10px] font-bold tracking-[0.5em] ">
 ...
 <h3 className="font-black text-lg tracking-widest mb-6 pt-4 italic">{item.title}</h3>
 ...
 <h2 className="relative z-10 text-4xl md:text-7xl font-black tracking-tighter mb-12 italic leading-[0.9] max-w-5xl text-white">
 ...
 <p className="relative z-10 text-gray-400 text-[10px] font-bold tracking-[0.6em] max-w-2xl mx-auto leading-loose">
