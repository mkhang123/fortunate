                    ...
                    {isAdmin && (
                        <div className="px-4 py-3 border-b bg-gray-50 flex items-center gap-2">
                            <button
                                ...
                                className={`px-3 py-1.5 text-[11px] font-bold rounded-full transition-colors ${productViewFilter === "all"
                                        ? "bg-black text-white"
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-[11px] font-bold rounded-full transition-colors ${productViewFilter === "pending"
                                        ? "bg-black text-white"
                                        : "bg-white text-gray-500 border border-gray-200"
                                    }`}
                            >
                            ...
                            {products.map((p) => (
                                ...
                                >
                                    ...
                                    <td className="p-4 text-center">
                                        <span
                                            className={`text-[10px] font-bold px-2.5 py-1 rounded-full ${statusClassMap[p.status] || "bg-gray-100 text-gray-600"
                                                }`}
                                        >
